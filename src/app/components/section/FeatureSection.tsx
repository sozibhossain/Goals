      ...
      <div className="container">
        <div className="flex lg:flex-row flex-col justify-between gap-10 lg:gap-0">
          ...
          <div className="lg:w-[48%] w-full">
            ...
            {/* {/ {/ Bottom text /} /} */}
            <p className="lg:text-[30px] md:text-[32px] text-[24px] text-white leading-[100%] font-normal text-center mt-8">
          ...
          <div className="lg:w-[48%] w-full">
            <div className="flex justify-center">
              {/* {/ {/ Top text /} /} */}
              <div className="">
                <p className="lg:text-[30px] md:text-[32px] text-[24px] text-white leading-[100%] font-normal text-center mb-8 md:mb-10 lg:mb-10">
